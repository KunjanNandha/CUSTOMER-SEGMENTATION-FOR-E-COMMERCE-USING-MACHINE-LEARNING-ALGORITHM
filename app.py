...
avg_values = pd.read_pickle(r"C:\Users\Kunjan Nandha\Downloads\Project\avg_values.pkl")
...
def main():
    ...
    last_purchase_date = st.sidebar.date_input('Last Purchase Date', value=pd.Timestamp('2023-12-01'), min_value=pd.Timestamp('2023-12-01'), max_value=pd.Timestamp('2024-12-09'))
    ...
    # Calculate number of days from last purchase date to 2024/12/09
    num_days = (pd.Timestamp('2024-12-09') - last_purchase_date).days
